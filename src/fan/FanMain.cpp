...
{
    auto getter =
        std::make_shared<GetSensorConfiguration>(dbusConnection,
                                                 [&io, &objectServer,
                                                  ...
                                                  sensorsChanged](
                                                     ...
                                                     {
                                                         lg2::error(
                                                             "No fan sensors in system");
                                                         return;
                                                     }

                                                     // iterate through all
                                                     // found fan sensors, and
                                                          ...
                                                          paths)
                                                     {
                                                         ...
                                                         {
                                                             lg2::error(
                                                                 "error populating thresholds for '{NAME}'",
                                                                 "NAME",
                                                                 sensorName);
                                                         }
                                                             ...
                                                             sensorData->end())
                                                         {
                                                             ...
                                                             {
                                                                 lg2::error(
                                                                     "Malformed Presence Configuration");
                                                             }
                                                             else
                                                             {
                                                                 bool inverted =
                                                             ...
                                                             sensorData->end())
                                                         {
                                                             ...
                                                             {
                                                                 lg2::error(
                                                                     "Connector for '{NAME}' missing pwm!",
                                                                     "NAME",
                                                                     sensorName);
                                                             }
